...
export type UseFilterProps<TFieldValues extends FieldValues = FieldValues, TContext = any> = Partial<{
    disabled: boolean;
...
export type UseFilterRegisterReturn<TFieldName extends InternalFieldName = InternalFieldName> = {
...
export type FilterProps<TFieldValues extends FieldValues = FieldValues, TContext = any> = Partial<{
