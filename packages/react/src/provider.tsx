...
import { UseFilterProps } from "./types/filter";
import { FilterContextType, FilterProviderProps } from "./types/context";
import { FieldValues } from "./types/field";
import { createControl } from "./implementation/createControl";
import { deepEqual, isFunction } from "./implementation/utils";
import { useSubscribe } from "./useWatch";
import { FilterState } from "./types/control";
...
export function useFilter<
    ...
    TContext = any
    > (props: UseFilterProps<TFieldValues, TContext> = {}): FilterContextType<TFieldValues, TContext>  {
